...
public class Tool {
    // Die Methode rechnet Fakultät einer Zahl aus
    ...
    // Die Methode gibt die Anleitung für das Buchstaben tauschen aus
    ...
    // Die Methode soll später dazu dienen den Schlüssel auszugeben und macht nebenbei die sortierten Buchstaben der Reihe nach in eine Liste
    ...
    // Die Methode gibt den Schlüssel aus, wie der Text verschlüsselt ist
    ...
    // Die Methode gibt den Schlüssel aus, sowie die Stelle an der sich der Buchstabe im Schlüssel befindet
    ...
    // Die Methode zählt die Anzahl jedes Buchstaben in eimem Text
    ...
    // Die Methode zählt die Wörter in einem Text
    ...
    // Die Methode tauscht die Buchstaben in einem Text
    ...
    // Die Methode nimmt die ersten 4 Buchstaben einer Liste
    ...
    // Die Methode macht aus einer List<LetterCounter> eine List<String>
    ...
    // Die Methode macht aus einem String eine Liste
    ...
    // Die Methode tauscht die Werte von 2 Arrayplätzen
    ...
    // Die Methode gebt den summierten count aller gezählten Wörter zurück
    ...
    // Die Methode kann alle möglichen Permultation mit 3 Buchstaben durchführen
    ...
    // Die Methode kann alle möglichen Permultation mit 4 Buchstaben durchführen
    ...
    // Die Methode probiert alle Permutationen von 3 oder 4 Buchstaben aus und zählt deren Wörter, bei der Permutation, bei der am meisten Wörter gezählt worden sind, wird die Permutation im Schlüssel ersetzt
    ...
    // Die Methode ist für den letzten Schritt zuständig, bei der der Benutzer noch 2 Buchstaben tauschen kann im Text
